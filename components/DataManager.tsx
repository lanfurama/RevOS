...
export const DataManager: React.FC = () => {
  ...
  const saveImport = () => {
    if (previewData) {
      ...
      setPreviewData(null);
      setCsvInput('');
      alert(`Successfully updated dataset with ${previewData.length} rows.`);
    }
  };
  ...
  // Actions Wrappers for Confirmation
  const handleReset = () => {
      ...
      <div className="bg-white p-6 rounded-sm shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div>
              ...
              <button 
                ...
                className="w-full flex justify-center items-center gap-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-3 rounded text-sm font-medium transition-colors border-dashed"
              >
          ...
          <div className="lg:col-span-2 flex flex-col h-[450px]">
            ...
            {/* The Table */}
            <div className={`flex-1 overflow-auto border-b border-l border-r rounded-b ${
              ...
              <table className="w-full text-xs text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 bg-white">
                  {displayData.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="p-8 text-center text-gray-400 italic">No data available</td>
                    </tr>
                  ) : (
